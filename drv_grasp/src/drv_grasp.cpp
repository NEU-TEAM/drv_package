    ...
    const sensor_msgs::CameraInfoConstPtr& cameraInfo)
{
  ...
  MakePlan MP;
  pcl::PointXYZ graspPt; // in robot's camera optical frame
  pcl::PointXYZ opticalPt; // target location in camera's optical frame
  ...
  {
    ROS_ERROR("Some coordinate values are NaN.\n");
  }
}
