...
void FaceDetector::detectAndDraw(Mat img_in, Mat &img_out, CascadeClassifier& cascade, CascadeClassifier& nestedCascade,
                                                                        double scale, bool tryflip, vector<Rect> &face_roi)
{
    int i = 0;
