...
Search::Search(int minpx = 0, int maxpx = 180, int xstep = 30, int minpy = 60, int maxpy = 80, int ystep = 10)
{
    minPX = minpx;
    maxPX = maxpx;
    xStep = xstep;
...
bool Search::getTargetPosition(std::vector<std_msgs::UInt16MultiArray> bbox_array, int num, int &delta_pitch, int &delta_yaw)
{
